...
try {
    ...
    // SQL query to select from habilidades_cursos by idCurso
    $sql = "SELECT * FROM habilidades_cursos WHERE id_curso = ?";
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Habilidades del curso obtenidas',
