...
try {
    ...
    // SQL query to select objetivos_especificos by idCurso
    $sql = "SELECT * FROM objetivos_cursos WHERE id_curso = ? AND tipo = 'especifico'";
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Objetivos Específicos obtenidos',
